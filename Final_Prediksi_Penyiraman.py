...
try:
    ...
    # === PERUBAHAN DI SINI ===
    # Membaca kredensial dari file yang dibuat oleh GitHub Actions
    ...
    # Pastikan nama file model Anda sesuai
...
try:
    ...
    print(f"\n❌ Terjadi error pada proses utama: {e}")
>>>>>>> fe7e2936bef272684eed6f28439b497e4db530f4
